...
llm_gemini = ChatGoogleGenerativeAI(google_api_key=my_key_google, model="gemini-1.5-flash-latest")
...
# Not: Görseldeki fonksiyon adı ve parametreleri tam görünmüyor.
# Aşağıdaki kod, görünen yapıya göre oluşturulmuştur.
